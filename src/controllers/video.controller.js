...
const getAllVideos = asyncHandler(async (req, res) => {
    try {
        ...
        throw new ApiError(500, "Something went wrong while generating pipeling")
    }
});
...
const updateVideo = asyncHandler(async (req, res) => {
    ...
    if(thumbnailLocalPath){
        ...
        video.thumbnail = await uploadOnCloudinary(thumbnailLocalPath)
        ...
        // or old url will be set again
         const video = await Video.findById(videoId)
        video.thumbnail = currentVideo.thumbnail
    }
...
const deleteVideo = asyncHandler(async (req, res) => {
    ...
    await deleteFromCloudinary(deletedVideo.videoFile[0].public_id)
    await deleteFromCloudinary(deletedVideo.thumbnail[0].public_id)
